...
msg = MIMEText("テストメールです".encode("utf-8"), "plain", "utf-8")
msg["Subject"] = Header("テスト", "utf-8").encode()
...
with smtplib.SMTP("smtp.gmail.com", 587, local_hostname="localhost") as server:
    ...
    server.sendmail(SENDER_EMAIL, SENDER_EMAIL, msg.as_bytes())
...
class TodoApp:
    ...
    def update_listbox(self):
        ...
        for task in self.tasks:
            ...
            display_text = f"[{status}] {task['text']} 期限:{task['deadline']}"
